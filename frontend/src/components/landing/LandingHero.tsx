      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        >
          ...
          <div className="lux-hero-preview__shell">
            ...
            <div className="rounded-[2rem] border border-[#D4AF37]/12 bg-[#050505]/85 p-5 lux-text-soft shadow-inner backdrop-blur-md transition-colors duration-700 group-hover:border-[#D4AF37]/22">
