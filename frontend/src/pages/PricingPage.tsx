    ...
    <div className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-slate-700"><strong>EUR 500</strong> setup iniziale (una tantum)</p>
          <p className="text-slate-700"><strong>EUR 199/mese</strong> canone ricorrente</p>
          <p className="mt-2 text-slate-600">CRM, AI, marketing, fedelta, analytics, report fiscal, pagamenti digitali inclusi.</p>
        </div>
